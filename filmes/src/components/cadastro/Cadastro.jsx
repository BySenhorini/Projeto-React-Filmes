                ...
                <div className="campos_cadastro">
                    <div className="campo_cad_nome">
                        ...
                        <input type="text" name="nome" placeholder={`Digite o nome do ${props.placeholder}`}
                            ...
                            // e => atualizar o estado do pai ao digitar.
                            //Target => esta indo buscar o valor do "e"
                            onChange={(e) => props.setValorInput(e.target.value)} />
                    </div>
                    <div className="campo_cad_genero" style={{ display: props.visibilidade }}>
                        <label htmlFor="genero">Genero:</label>
                        <select name="" id="" value={props.valorSelect}onChange={(e)=> props.setValorSelect(e.target.value)}>
                        ...
                        /*selected: faz com a opcao ja venha selecionada */}
                            ...
                            {props.lista && props.lista.length >
                                0 && props.lista.map((itemGenero) =>
                                    <option value="">{itemGenero.nome}
                                    </option>)}
                        </select>
                    </div>
